# Distributor Portal Deployment Setup
...
Write-Host "2. Push your code: git remote add origin YOUR_REPO_URL" -ForegroundColor White
Write-Host "3. Push: git push -u origin main" -ForegroundColor White
Write-Host "4. Deploy to Vercel: vercel login and vercel" -ForegroundColor White
